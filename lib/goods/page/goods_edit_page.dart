...
class GoodsEditPage extends StatefulWidget {
  const GoodsEditPage({super.key, this.isAdd = true, this.isScan = false, this.heroTag, this.goodsImageUrl});
    ...
    return Scaffold(
        ...
        body: MyScrollView(
          ...
          children: <Widget>[
            ...
            Gaps.vGap16,
            const TextFieldItem(title: '立减金额', keyboardType: TextInputType.numberWithOptions(decimal: true)),
            const TextFieldItem(title: '折扣金额', keyboardType: TextInputType.numberWithOptions(decimal: true)),
            Gaps.vGap32,
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text(
